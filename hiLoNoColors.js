//Import of the prompt-sync Node module
//If you have both npm and Node.js, run 'npm install prompt-sync' in the terminal to install prompt-sync
...
const gameStart = () => {
    console.log('\n');
    let amountBet = prompt('How many dollars would you like to bet on this game? Please remember that the house only accepts amounts in multiples of 10. ');
    ...
    if (amountBet % 10 !== 0) {
        ...
        const game = () => {
            ...
            let inp = prompt('Do you think your card will be higher or lower in value? [h/l] ');
            inp = inp.toLowerCase();
            if (inp === 'higher' | inp === 'h' | inp === 'high' | inp === 'up') {
                ...
                console.log(`\nNext time, please input one of the following commands:\n` + "'higher', 'h', 'high' or 'up'" + ` to indicate that you expect your card to be of a higher value than the dealer's card, or\n` + "'lower', 'l', 'low' or 'down'" + ` to indicate that you expect your card to be of a lower value than the dealer's card.`);
                game();
            };
            ...
            if (win === 'yes') {
                ...
                console.log(`You were right! The amount in the pot is currently: $${Math.floor(amountBet)}.`);
                ...
                console.log(`\nYour card is the ${playerCard[0]} of ${playerSuit}.\n`);
                console.log(`You were wrong. You have lost the game and the entire pot worth $${Math.floor(amountBet)} goes to the dealer. Thank you for your patronage.`);
                
                const nextMatchChoice = () => {
                    console.log('\nWould you like to try again?\n');
                    let nextRoundChoice = prompt('[y/n?]: ');
